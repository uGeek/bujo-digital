...
El contingut de Bullet Journal Digital es basa en https://bulletjournal.com
    ...
    **Rapid Loggin** és l'idioma en què parla Bullet Journal, el qual consta de quatre components:
    ...
    Organitzar-se amb arxius annexes (secció no acabada):
    ...
    ** school.org_archive
    ...
    Per tal que tot funcione cal escriure la configuració d'aquestes funcionalitats a l'arxiu .emacs i explicar com s'arxiva el tros de text que volem arxivar. Ho explicarem pròximament.
* Calendar
                            2019
